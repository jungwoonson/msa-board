package jungwoonson.board.common.outboxmessagerelay;
...
class AssignedShardTest {
    ...
    void ofTest() {
        ...
        List<Long> result = Stream
                .of(assignedShard1.getShards(), assignedShard2.getShards(), assignedShard3.getShards(), assignedShard4.getShards())
                .flatMap(List::stream)
                .toList();
